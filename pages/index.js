...
export default function Home({ products }) {
  ...
  return (
    <Layout title="Welcome">
      <h1 className={styles.title}>Welcome to the best <strong>Sport Store!</strong></h1>
      ...
      <div className={styles.latestSection}>
        ...
        <div className={styles.latestGrid}>
          {products &&
            products.map((item) => (
              <Card item={item} key={item.name} tag={true}/>
            ))}
        </div>
      ...
      <div className={styles.imageSection}>
        ...
        <Image alt="No limits gif" width={350} height={400} src="/../public/img/gif.gif" objectFit="contain"/>
        </div>
      </div>
      </section>
    </Layout>
